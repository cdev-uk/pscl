...
void test_lmin_a_equals_b(void) {
    TEST_ASSERT_EQUAL_INT(5, pscl_lmin(5, 5));
}

void test_lmin_a_less_than_b(void) {
    TEST_ASSERT_EQUAL_INT(1, pscl_lmin(1, 2));
}

void test_lmin_a_greater_than_b(void) {
    TEST_ASSERT_EQUAL_INT(1, pscl_lmin(2, 1));
}

void test_lmax_a_equals_b(void) {
    TEST_ASSERT_EQUAL_INT(5, pscl_lmax(5, 5));
}

void test_lmax_a_less_than_b(void) {
    TEST_ASSERT_EQUAL_INT(2, pscl_lmax(1, 2));
}

void test_lmax_a_greater_than_b(void) {
    TEST_ASSERT_EQUAL_INT(2, pscl_lmax(2, 1));
}
